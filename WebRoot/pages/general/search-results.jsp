...
if(searchString==null||"".equals(searchString)){
	response.sendRedirect(basePath+"pages/general/index.jsp");
	return;
}else{
...
<html class="no-js" lang="">
    <head>
        ...
        <title>SynixMall || Search Result</title>
        <meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0"> 
        <meta name="description" content="SynixMall Search Result">
    ...
    <body class="product-grid">
                ...
                <div class="row">
                    <div class="col-md-7 col-md-offset-3">
                        <ul class="breadcrumb">
                            ...
                            <li class="active" type="" currentId="" id="currentCategory">SearchResult</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <div class="cat-menu">
                            <ul id="category">
                                <li class="cat-title"><a href="#">Search Results</a></li>
                            </ul>
                        </div>
        ...
        <script type="text/javascript" src="js/self/general/search-results.js"></script>
        
        <!-- specific -->
        <script type="text/javascript">
        	$(document).ready(function(){
        		initUpperShopcart();
        		getSearchPages(1,12,getPagi1);
        	});
        </script>
