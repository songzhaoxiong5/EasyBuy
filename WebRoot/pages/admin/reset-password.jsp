...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageScope.basePath}lib/adminbootstrap/css/bootstrap-responsive.css">
        ...
        <div class="block">
            ...
            <div class="block-body">
                <form>
                    ...
                    <a href="${pageScope.basePath}pages/admin/index.jsp" class="btn btn-primary pull-right">Send</a>
                    <div class="clearfix"></div>
                </form>
            </div>
        </div>
        <a href="${pageScope.basePath}pages/admin/sign-in.jsp">Sign in to your account</a>
    </div>
</div>
</div>
