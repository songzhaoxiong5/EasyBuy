   ...
   <%@ include file="console_elements/sidebar.jsp" %>
		...
		<div class="well">		      
			    <div class="box-content">
							<form class="form-horizontal" id="newsAddForm" method="post" action="" enctype="multipart/form-data">
							  <fieldset>
							  <div id="result" style="display:none;" class="alert alert-info" role="alert"></div>
								<legend id="legend">Add News</legend>
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<textarea  id="textarea2" rows="5"  name="content" value="" class="span6"></textarea>
								  </div>
								</div>
...
$(document).ready(function(){
		...
		$("#submitButton").click(function(){
				if($("#newsAddForm").valid()){
						...
						var myForm=document.getElementById("newsAddForm");//获取前台表单
