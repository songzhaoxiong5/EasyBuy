  ...
  <!--<![endif]-->
   ...
   <%@ include file="console_elements/navbar.jsp" %>
    ...
    <div class="container-fluid">
        ...
        <div class="span9">
            <script type="text/javascript" src="${pageScope.basePath}lib/admin/jqplot/jquery.jqplot.min.js"></script>
			<script type="text/javascript" charset="utf-8" src="${pageScope.basePath}js/admin/graphDemo.js"></script>

<div class="stats">
    <p class="stat"><span class="number" id="numOfUsers"></span>Users</p>
    <p class="stat"><span class="number" id="numOfProducts"></span>Products</p>
    <p class="stat"><span class="number" id="numOfOrders"></span>Orders</p>
    <p class="stat"><span class="number" id="numOfNews"></span>News</p>
</div>
...
<div class="row-fluid">
    <div class="block span6">
        ...
        <div id="tablewidget" class="block-body collapse in">
            ...
            <p><a href="${pageScope.basePath}pages/admin/users.jsp">More...</a></p>
        </div>
    </div>
    <div class="block span6">
  	...
  	<script type="text/javascript">
  		$(document).ready(function(){
  			...
  			$.getJSON("usercontrol",sent,function(data){
  				var $pageObj=data[1];
  				$("#numOfUsers").html($pageObj.totalCount);
  			});
  			$.getJSON("productcontrol",sent,function(data){
  				var $pageObj=data[1];
  				$("#numOfProducts").html($pageObj.totalCount);
  			});
  			$.getJSON("ordercontrol",sent,function(data){
  				var $pageObj=data.pageObj;
  				$("#numOfOrders").html($pageObj.totalCount);
  			});
  			$.getJSON("newscontrol",sent,function(data){
  				var $pageObj=data[1];
  				$("#numOfNews").html($pageObj.totalCount);
  			});
