<%@ page language="java" import="java.util.*,com.szx.bean.*,com.szx.service.impl.*" pageEncoding="UTF-8"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%
String path = request.getContextPath();
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
pageContext.setAttribute("basePath", basePath);
pageContext.setAttribute("pageIndex", 1);
%>
...
<html lang="en">
  ...
  <%@ include file="console_elements/navbar.jsp" %>
	...
	<div class="btn-toolbar">
	    <button class="btn btn-primary" id="add"><i class="icon-plus"></i> New User</button>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script src="js/self/admin/util.js" type="text/javascript"></script>
    <script src="${pageScope.basePath}/js/self/admin/getpagi.js" type="text/javascript"></script>
    <script type="text/javascript">
    	$(document).ready(function(){
    	$("#add").click(function(){
    		location.href="pages/admin/user_add.jsp";
    	});
    		getPagi(1,"usercontrol");
    		$("div.span9").on("click","#modalDel",function(){
	    		$("#myModal").modal('hide');
	    		var data="opr=del&delId="+$("#delId").val();
	    		$.getJSON("usercontrol",data,refresh);
